...
class TestLogic(unittest.TestCase):
	...
	def test_adder(self):
		...
		assumptions = {'a_0':True,'a_1':False,'a_2':False,'a_3':False,'a_4':False,
					   'b_0':True,'b_1':True,'b_2':False,'b_3':False,'b_4':False}
	...
	def test_popcount(self):
		...
		assumptions = {'in_0':True,'in_1':False,'in_2':False,'in_3':True,'in_4':False}
	...
	def test_mux(self):
		...
		assumptions = {'in_0':True,'in_1':True,'in_2':False,'in_3':True,'in_4':False,
						'sel_0':True,'sel_1':False,'sel_2':False}
		result = sat(p,assumptions)
		self.assertTrue(result['out'])
