...
class TestCircuit(unittest.TestCase):
    ...
    def test_fanout(self):
        ...
        self.assertSetEqual(self.c17.fanout(
            ['G1', 'G8']), self.c17.fanout('G1') | self.c17.fanout('G8'))

    def test_node(self):
        self.assertFalse(self.s27.nodes('nand') & self.c17.nodes('lat'))
        self.assertSetEqual(self.s27.nodes('ff'), set(['G7', 'G6', 'G5']))
        self.assertSetEqual(self.s27.nodes('input'), set(
            ['clk', 'G0', 'G1', 'G2', 'G3']))
    ...
    def test_endpoints(self):
        self.assertSetEqual(self.s27.endpoints(), set(
            ['d[G5]', 'd[G6]', 'd[G7]', 'output[G17]']))
        self.assertSetEqual(self.s27.endpoints(
            'n_20'), set(['output[G17]']))
        self.assertSetEqual(self.s27.endpoints(['n_20', 'n_11']),
                            set(['output[G17]', 'd[G5]']))

    def test_startpoints(self):
        self.assertSetEqual(self.s27.startpoints(), set(
            ['G5', 'G6', 'G7', 'clk', 'G0', 'G1', 'G2', 'G3']))
